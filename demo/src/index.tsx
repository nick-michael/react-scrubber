    ...
    return (
      <div>
        <a
          ...
          href="https://github.com/nick-michael/react-scrubber"
          target="blank"
        >
        ...
        <div className="content-container">
          ...
          <div className="block">
            <div className="description">
              The scrubber has default styling applied to it, here's what it
              looks like to start with!
            </div>
            <div className="scrubber-container" style={{ height: "20px" }}>
              <Scrubber min={0} max={100} value={40} />
            </div>
          </div>
          <div className="block">
            <div className="description">
          ...
          <div className="block">
            <div className="description">
              The scrubber will fill the width of it's container by default. The
              scrubber will also fill the height of it's container, but this
              will only be noticable for hover &amp; click detection,{" "}
              <strong>the bar graphic will stay the same height.</strong>
            </div>
          ...
          <div className="block">
            <div className="description">
              Although this is a generic scrubber, there is support for an
              optional buffer bar and arbitrary markers.
              <br />
              <br />
              Markers can be either a number or an object containing{" "}
              <code>{`{ start: number, end: number, className: string }`}</code>{" "}
              where <code>end</code> and <code>className</code> are optional.
              For numerical markers, or markers with no end point specified, a
              default width will be applied.
            </div>
            <div className="scrubber-container" style={{ height: "20px" }}>
              <Scrubber
                min={0}
...
/>`}</code>
          ...
          <div className="block">
            <div className="description">
              All the elements have class names so the style can be overriden.
              You can also pass down a class name into the className prop.
              <br />
              <br />
              The scrubber will also have a 'hover' class applied on mouse enter
              and on touch.
            </div>
          ...
          <div className="block" style={{ textAlign: "center" }}>
            ...
            >
              Vertical scrubbing is possible using the <code>"vertical"</code>{" "}
              prop.
            </div>
            <div
              style={{
            ...
            >
              <div
                ...
                style={{ height: "80px", width: "20px", margin: "auto" }}
              >
                <Scrubber
                  vertical
                  min={0}
